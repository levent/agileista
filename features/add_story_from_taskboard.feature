...
Background:
  ...
  Scenario: Add story directly to sprint from taskboard
    ...
    And I fill in "Definition" with "As a user I'd like to accomplish things"
    And I fill in "Story points" with "8"
    And I fill in "New theme" with "theme"
    And I press "Add to task board"
    And I am on "the backlog page"
    And I follow "Task board"
    Then I should see "As a user I'd like to accomplish things"
